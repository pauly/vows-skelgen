'use strict'
/**
 * generated by /Users/paulclarke/.nvm/versions/node/v10.22.0/bin/node,/Users/paulclarke/sites/js-skelgen/skelgen.js,lib/skelgen.js,--output,test/skelgen.js
 * https://github.com/pauly/vows-skelgen
 * Sat Jan 09 2021 17:46:17 GMT+0000 (Coordinated Universal Time)
 */

const expect = require('chai').use(require('dirty-chai')).expect
const file = './../lib/skelgen.js'
const skelgen = require(file)
...
describe('skelgen.js', function () {
  ...
  describe('skelgen.assertsFrom', function () {
    it('handles good input', function () {
      /* 19 asserts, 19 long asserts */ let expected = [['1', '==', '1', '']]
  ...
  describe('skelgen.fixturesFrom', function () {
    it('handles good input', function () {
      const expected = ['./foo.js', '../foo/bar.js']
