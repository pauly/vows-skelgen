 ...
 * Thu Aug 29 2013 13:45:19 GMT+0000 (UTC)
 */
...
describe( 'handles good input asynchronously', function ( ) {
...
describe( 'skelgen.arbitraryAsyncMethod handles malformed input', function ( ) {
...
describe( 'skelgen.anotherArbitraryAsyncMethod handles malformed input', function ( ) {
  it( 'handles foo', function ( ) {
    skelgen.anotherArbitraryAsyncMethod( 'foo', function ( err, result ) {
